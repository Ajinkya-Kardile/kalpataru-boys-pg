...
export function AmenitieCardSm({ title, icon, iconColor, description }) {
...
AmenitieCardSm.displayName = "/src/widgets/layout/amenitie-card.jsx";

export default AmenitieCardSm;
